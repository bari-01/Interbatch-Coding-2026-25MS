  ...
  help: (): CommandResult => ({
    output: [
      ...
      formatSection('Easter Eggs', [
        ...
        `${c.magenta}git status${c.reset}                ${c.gray}???${c.reset}`,
      ...
      formatSection('Terminal', [
        `${c.cyan}cursor block${c.reset}              ${c.gray}Block cursor style${c.reset}`,
        `${c.cyan}cursor bar${c.reset}                ${c.gray}Bar cursor style${c.reset}`,
        `${c.cyan}cursor underline${c.reset}          ${c.gray}Underline cursor style${c.reset}`,
        `${c.cyan}theme green${c.reset}               ${c.gray}Switch to green theme${c.reset}`,
        `${c.cyan}theme amber${c.reset}               ${c.gray}Switch to amber theme${c.reset}`,
        `${c.cyan}theme blue${c.reset}                ${c.gray}Switch to blue theme${c.reset}`,
        `${c.cyan}theme red${c.reset}                 ${c.gray}Switch to red theme${c.reset}`,
        `${c.cyan}theme purple${c.reset}              ${c.gray}Switch to purple theme${c.reset}`,
      ]),
